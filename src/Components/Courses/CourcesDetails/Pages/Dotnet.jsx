...
import dotnetHeroImage from '/images/Dotnet1.png';
import dotnetLabImage from '/images/Dotnet2.png';
      ...
      <main>
        ...
        <div className="relative h-[400px] bg-gradient-to-r bg-[#1983D3] overflow-hidden">
          <div className="absolute inset-0 flex items-start pt-12 justify-between px-8">
            ...
            <img
              src={dotnetHeroImage} // Add hero image
              alt="Dot Net Full Stack"
        ...
        <div className="max-w-7xl mx-auto px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <img
                src={dotnetLabImage} // Add laboratory image
                alt="Laboratory Work"
