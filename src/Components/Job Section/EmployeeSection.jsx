    ...
    <div className="min-h-screen bg-[linear-gradient(148.05deg,#C6D5F6_0%,#EAF0FF_48.94%,#DEE8FF_97.87%)] px-4 py-12 font-sans">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-[#666666] text-lg mb-6">Hire in 30 Mins</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-[#666666] text-lg leading-relaxed">
              Trusted by top recruiters and job seekers, Univoc simplifies
              hiring with a seamless experience and unmatched opportunities
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between mt-8 gap-8">
            ...
            <div className="mt-6 md:mt-0 md:w-1/2 md:pl-10 flex flex-col justify-center">
              ...
              <button
                className="mt-6 px-6 py-2 bg-blue-500 text-white rounded-lg shadow-md hover:bg-blue-600 self-start"
                onClick={() =>
                  (window.location.href =
                    "https://docs.google.com/forms/d/e/1FAIpQLScQYL3NGXmUtFFkRcrYQfI-qkUjjPPRbGjemLiVhae5D3cU9w/viewform?usp=dialog")
                }
              >
                Post Your CV
              </button>
